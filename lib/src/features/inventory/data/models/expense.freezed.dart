...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String description,  double amount,  DateTime date, @JsonKey(name: 'pallet_id')  String? palletId, @JsonKey(name: 'item_id')  String? itemId,  String? category, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Expense() when $default != null:
return $default(_that.id,_that.description,_that.amount,_that.date,_that.palletId,_that.itemId,_that.category,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String description,  double amount,  DateTime date, @JsonKey(name: 'pallet_id')  String? palletId, @JsonKey(name: 'item_id')  String? itemId,  String? category, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Expense():
return $default(_that.id,_that.description,_that.amount,_that.date,_that.palletId,_that.itemId,_that.category,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String description,  double amount,  DateTime date, @JsonKey(name: 'pallet_id')  String? palletId, @JsonKey(name: 'item_id')  String? itemId,  String? category, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Expense() when $default != null:
return $default(_that.id,_that.description,_that.amount,_that.date,_that.palletId,_that.itemId,_that.category,_that.createdAt,_that.updatedAt);case _:
  return null;
