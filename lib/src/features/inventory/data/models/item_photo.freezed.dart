...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'item_id')  String itemId, @JsonKey(name: 'image_url')  String imageUrl,  String? description, @JsonKey(name: 'is_primary')  bool isPrimary, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ItemPhoto() when $default != null:
return $default(_that.id,_that.itemId,_that.imageUrl,_that.description,_that.isPrimary,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'item_id')  String itemId, @JsonKey(name: 'image_url')  String imageUrl,  String? description, @JsonKey(name: 'is_primary')  bool isPrimary, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ItemPhoto():
return $default(_that.id,_that.itemId,_that.imageUrl,_that.description,_that.isPrimary,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'item_id')  String itemId, @JsonKey(name: 'image_url')  String imageUrl,  String? description, @JsonKey(name: 'is_primary')  bool isPrimary, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ItemPhoto() when $default != null:
return $default(_that.id,_that.itemId,_that.imageUrl,_that.description,_that.isPrimary,_that.createdAt,_that.updatedAt);case _:
  return null;
