...
/// Adds pattern-matching-related methods to [Pallet].
extension PalletPatterns on Pallet {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Pallet value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Pallet() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Pallet value)  $default,){
final _that = this;
switch (_that) {
case _Pallet():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Pallet value)?  $default,){
final _that = this;
switch (_that) {
case _Pallet() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(name: 'purchase_cost')  double cost,  String? type,  String? supplier,  String? source,  PalletStatus status, @JsonKey(name: 'purchase_date')  DateTime? purchaseDate, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Pallet() when $default != null:
return $default(_that.id,_that.name,_that.cost,_that.type,_that.supplier,_that.source,_that.status,_that.purchaseDate,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(name: 'purchase_cost')  double cost,  String? type,  String? supplier,  String? source,  PalletStatus status, @JsonKey(name: 'purchase_date')  DateTime? purchaseDate, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Pallet():
return $default(_that.id,_that.name,_that.cost,_that.type,_that.supplier,_that.source,_that.status,_that.purchaseDate,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name, @JsonKey(name: 'purchase_cost')  double cost,  String? type,  String? supplier,  String? source,  PalletStatus status, @JsonKey(name: 'purchase_date')  DateTime? purchaseDate, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Pallet() when $default != null:
return $default(_that.id,_that.name,_that.cost,_that.type,_that.supplier,_that.source,_that.status,_that.purchaseDate,_that.createdAt,_that.updatedAt);case _:
  return null;
