...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'pallet_id')  String palletId,  String name,  String? description,  int quantity, @JsonKey(name: 'purchase_price')  double? purchasePrice, @JsonKey(name: 'sale_price')  double? salePrice, @JsonKey(name: 'listing_price')  double? listingPrice, @JsonKey(name: 'listing_platform')  String? listingPlatform, @JsonKey(name: 'listing_date')  DateTime? listingDate, @JsonKey(name: 'selling_platform')  String? sellingPlatform, @JsonKey(name: 'sold_price')  double? soldPrice,  String? sku,  ItemCondition condition,  ItemStatus status, @JsonKey(name: 'storage_location')  String? storageLocation, @JsonKey(name: 'sales_channel')  String? salesChannel, @JsonKey(name: 'acquired_date')  DateTime? acquiredDate, @JsonKey(name: 'sold_date')  DateTime? soldDate, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'allocated_cost')  double? allocatedCost)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Item() when $default != null:
return $default(_that.id,_that.palletId,_that.name,_that.description,_that.quantity,_that.purchasePrice,_that.salePrice,_that.listingPrice,_that.listingPlatform,_that.listingDate,_that.sellingPlatform,_that.soldPrice,_that.sku,_that.condition,_that.status,_that.storageLocation,_that.salesChannel,_that.acquiredDate,_that.soldDate,_that.createdAt,_that.updatedAt,_that.allocatedCost);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'pallet_id')  String palletId,  String name,  String? description,  int quantity, @JsonKey(name: 'purchase_price')  double? purchasePrice, @JsonKey(name: 'sale_price')  double? salePrice, @JsonKey(name: 'listing_price')  double? listingPrice, @JsonKey(name: 'listing_platform')  String? listingPlatform, @JsonKey(name: 'listing_date')  DateTime? listingDate, @JsonKey(name: 'selling_platform')  String? sellingPlatform, @JsonKey(name: 'sold_price')  double? soldPrice,  String? sku,  ItemCondition condition,  ItemStatus status, @JsonKey(name: 'storage_location')  String? storageLocation, @JsonKey(name: 'sales_channel')  String? salesChannel, @JsonKey(name: 'acquired_date')  DateTime? acquiredDate, @JsonKey(name: 'sold_date')  DateTime? soldDate, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'allocated_cost')  double? allocatedCost)  $default,) {final _that = this;
switch (_that) {
case _Item():
return $default(_that.id,_that.palletId,_that.name,_that.description,_that.quantity,_that.purchasePrice,_that.salePrice,_that.listingPrice,_that.listingPlatform,_that.listingDate,_that.sellingPlatform,_that.soldPrice,_that.sku,_that.condition,_that.status,_that.storageLocation,_that.salesChannel,_that.acquiredDate,_that.soldDate,_that.createdAt,_that.updatedAt,_that.allocatedCost);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'pallet_id')  String palletId,  String name,  String? description,  int quantity, @JsonKey(name: 'purchase_price')  double? purchasePrice, @JsonKey(name: 'sale_price')  double? salePrice, @JsonKey(name: 'listing_price')  double? listingPrice, @JsonKey(name: 'listing_platform')  String? listingPlatform, @JsonKey(name: 'listing_date')  DateTime? listingDate, @JsonKey(name: 'selling_platform')  String? sellingPlatform, @JsonKey(name: 'sold_price')  double? soldPrice,  String? sku,  ItemCondition condition,  ItemStatus status, @JsonKey(name: 'storage_location')  String? storageLocation, @JsonKey(name: 'sales_channel')  String? salesChannel, @JsonKey(name: 'acquired_date')  DateTime? acquiredDate, @JsonKey(name: 'sold_date')  DateTime? soldDate, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'allocated_cost')  double? allocatedCost)?  $default,) {final _that = this;
switch (_that) {
case _Item() when $default != null:
return $default(_that.id,_that.palletId,_that.name,_that.description,_that.quantity,_that.purchasePrice,_that.salePrice,_that.listingPrice,_that.listingPlatform,_that.listingDate,_that.sellingPlatform,_that.soldPrice,_that.sku,_that.condition,_that.status,_that.storageLocation,_that.salesChannel,_that.acquiredDate,_that.soldDate,_that.createdAt,_that.updatedAt,_that.allocatedCost);case _:
  return null;
